...
static]]
image:https://ci.outskirtslabs.com/repos/github/outskirtslabs/nixos-hetzner-demo/badge.svg[alt=nixbot,link=https://ci.outskirtslabs.com/repos/github/outskirtslabs/nixos-hetzner-demo]
